-- Pre-3223ce9 layout after last_rest/is_pinned, then the 3223ce9 uid append,
-- followed by the 76c70e2 parent/variation appends.
...
INSERT INTO __fixture_exercises (
  ...
  last_rest_seconds, is_pinned, uid, parent_exercise_id, variation_label
)
SELECT
  id, name, description, muscle_group, equipment, is_bodyweight, created_at,
  last_rest_seconds, is_pinned, uid, parent_exercise_id, variation_label
